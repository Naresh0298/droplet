...
class TokenBuffer:
    ...
    def __init__(self, seq_len: int, eos_token: int):
        ...
        self.eos_token_id = eos_token                    # FIX 1: was self.eos_token_id = self.eos_token_id
        self.buffer = []
        self.chunks_produced = 0

    def add_document(self, token_ids):
        self.buffer.extend(token_ids)                    # FIX 2: was .extent()
...
class DatasetProcessor:
    ...
    # FIX 3: This method was OUTSIDE the class — now properly indented inside DatasetProcessor
    def process_documents(self, target_tokens):
        ...
        for example in dataset:
            ...
            if chunks:
                all_chunks.extend(chunks)            # FIX 4: was .extentd()
        ...
        pbar.close()                                     # FIX 5: was inside the for loop

        # Trim to exactly the target number of chunks
        all_chunks = all_chunks[:target_chunks]          # FIX 6: was inside the for loop
...
def prepare_data(args):
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.tokenizer_name)  # FIX 7: was tokenizer_name_name
    ...
    # FIX 8: Everything below was MISSING from your file
